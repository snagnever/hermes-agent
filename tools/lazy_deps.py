...
LAZY_DEPS: dict[str, tuple[str, ...]] = {
    ...
    # Claude Agent SDK — needed for the claude-agent provider /
    # model.anthropic_runtime: claude_agent_sdk (Claude via subscription OAuth
    # through the Claude Code subprocess). The `claude` CLI is a separate,
    # non-pip prerequisite (npm i -g @anthropic-ai/claude-code).
    "provider.claude_agent": ("claude-agent-sdk==0.2.110",),
